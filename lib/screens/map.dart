...
class Map extends StatefulWidget {
  ...
  final List<RegisteredRestaurantList> registeredRestaurants;

  Map({this.registeredRestaurants});
...
class MapState extends State<Map> {
  ...
  getUserLocation(LatLng latlng) async {//call this async method from whereever you need
